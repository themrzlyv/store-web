...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b transition-colors hover:bg-light-darker data-[state=selected]:bg-light-darker hover:dark:bg-dark-lighter dark:data-[state=selected]:bg-dark-lighter",
      className
    )}
    {...props}
  />
